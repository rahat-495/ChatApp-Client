  ...
  return (
    <div className="w-full h-full grid grid-cols-[48px,1fr] bg-white gro text-black">
      ...
      <div className="w-full">
        ...
        <div className="h-16 flex items-center m-0 p-0">
          <h2 className="text-xl font-bold p-4 text-black gro">Message</h2>
        </div>

        <div className="divider p-0 m-0 -mt-1"></div>
        ...
        <div className=" h-[calc(100vh-65px)] overflow-x-hidden overflow-y-auto">
          {
            ...
            //             />
            //         </div>
            //         <p className='text-lg text-center text-black font-semibold'>Explore users to start a conversation with.</p>
            //     </div>
            // )
          }
